...
import { ShoppingBag, ArrowRight, Mail, Phone, MapPin, Facebook, Instagram, Twitter, Heart, Search, User, Menu, ChevronLeft, ChevronRight, X, Star, Truck, Shield, RefreshCw, Sparkles } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <User className="w-5 h-5 cursor-pointer text-gray-600 hover:text-purple-600 transition-colors duration-300 hidden sm:block" />
              <div className="relative">
                <ShoppingBag className="w-5 h-5 cursor-pointer text-gray-600 hover:text-purple-600 transition-colors duration-300" />
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-4 py-6 space-y-4">
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">New Arrivals</a>
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">Women</a>
                <a href="#" className="block text-gray-700 hover:text-purple-600 transition-colors font-medium py-2">Children</a>
                <a href="#" className="block text-red-600 hover:text-red-700 transition-colors font-semibold py-2">Sale</a>
                <button
                  onClick={() => navigate("/login")}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate("/")}>
                  <div className="w-20 h-20  rounded-xl flex items-center justify-center  transform hover:rotate-6 transition-transform duration-300">
                    <span className=" font-bold text-lg"><img src={logo1} alt="" /></span>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-sm sm:text-base text-gray-400">
                ...
                <div className="flex items-start gap-3 group cursor-pointer">
                  ...
                  <span className="group-hover:text-white transition-colors">mosclothing459@gmail</span>
                </div>
                <div className="flex items-start gap-3 group cursor-pointer">
